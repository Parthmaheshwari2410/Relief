...
const SpecialityMenu = () => {
  return (
    <div className='flex flex-col items-center gap-4 py-16 text-gray-800 ' id='speciality'>
        ...
        <p className='sm:w-1/3 text-center text-sm'> We aim at delivering better health care services in a safe and compassionate environment to our patients guided by their needs and requirements. </p>
