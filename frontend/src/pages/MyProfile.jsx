...
const MyProfile = () => {
  ...
  return userData && (
    <div className='max-w-lg flex flex-col gap-2 text-sm'>
      ...
      {
        isEdit
          ? <input className='bg-gray-50 text-3xl font-medium masx-w-60 mt-4' type="text" value={userData.name} onChange={e => setUserData(prev => ({ ...prev, name: e.target.value }))} />
      ...
      <div >
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5  mt-3 text-neutral-700'>
          ...
          {
            isEdit
              ? <p> <input className='bg-gray-50' type="text" onChange={(e)=>setUserData(prev => ({...prev,address:{...prev.address,line1:e.target.value}}))} value={userData.address.line1} />
                <br />
      ...
      {
      isEdit
          ? <input className='max-w-28 bg-gray-100' type="text" onChange={e => setUserData(prev => ({ ...prev, dob: e.target.value }))} value={userData.dob} />
