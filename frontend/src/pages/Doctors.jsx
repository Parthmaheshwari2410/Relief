...
const Doctors = () => {
  ...
  return (
    ...
    <div>
      <p className='text-gray-600'>We aim at delivering better health care services in a safe and compassionate environment to our patients guided by their needs and requirements. </p>
        ...
        <div className='w-full grid grid-cols-auto gap-4 gap-y-6'>
          {
            filterDoc.map((item, index) => (
              <div onClick={() => navigate(`/appointment/${item._id}`)} className='border border-blue-200 rounded-xl overflow-hidden hover:translate-y-[-10px] transition-all duration-500' key={index}>
                ...
                <div className='p-4'>
                  <div className={`flex items-center gap-2 text-xm text-center ${item.available ? 'text-green-500' : 'text-red-500'}  `}>
